...
class Bishop(Piece):
    ...
    def availableMoves(self):
        ...
        :return: A set of the available moves the bishop can make.
                It is a set of tuples of the rows and colms that the move can move to
        :rtype: {(int,str)}
        """
        # Returns a set of the avaiable moves the Bishop can make
        moves = set()
    ...
    def possibleCapturesCheck(self):
        ...
        :return: A set of the available moves the bishop can make for check.
                It is a set of tuples of the rows and colms that the move can move to
        :rtype: {(int,str)}
        """
        moves = set()
